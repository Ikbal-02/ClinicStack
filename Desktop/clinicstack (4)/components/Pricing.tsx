...
const Pricing: React.FC = () => {
  ...
  return (
    <section id="pricing" className="py-24 relative min-h-[50vh]">
      {/* Background Glow */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-start">
          {tiers.map((tier, index) => (
            <motion.div
              ...
              className={`relative rounded-3xl p-8 border backdrop-blur-xl flex flex-col transform-gpu will-change-transform will-change-opacity ${
                tier.popular
