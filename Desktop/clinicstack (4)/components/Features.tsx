...
const Features: React.FC = () => {
  return (
    <section id="features" className="min-h-screen flex flex-col justify-center py-20 relative bg-slate-50 min-h-[50vh]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="space-y-32 md:space-y-64">
          ...
          <motion.div 
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center relative transform-gpu will-change-transform will-change-opacity"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0, margin: "2000px" }}
            transition={{ duration: 0.5 }}
            className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative transform-gpu will-change-transform will-change-opacity"
          >
