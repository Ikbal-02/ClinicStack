...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="min-h-screen flex flex-col justify-center py-20 relative bg-white min-h-[50vh]">
        {/* Ambient background */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="relative">
             ...
             <motion.div 
                ...
                className="bg-white/80 border border-slate-200 p-6 md:p-8 rounded-3xl backdrop-blur-xl shadow-xl transform-gpu will-change-transform will-change-opacity"
             >
                {formState === 'success' ? (
