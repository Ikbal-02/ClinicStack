...
const Comparison: React.FC = () => {
  return (
    <section id="comparison" className="min-h-screen flex flex-col justify-center py-20 relative bg-slate-50 min-h-[50vh]">
      <GlobalTicker />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 border border-slate-200 text-slate-500 text-[11px] font-medium tracking-wider uppercase mb-6 backdrop-blur-md shadow-sm transform-gpu will-change-transform will-change-opacity"
            >
            ...
            <motion.h2 
              ...
              className="text-4xl md:text-5xl font-medium text-slate-900 tracking-tight mb-6 font-sans transform-gpu will-change-transform will-change-opacity"
            >
            ...
            <motion.p 
              ...
              className="text-lg text-slate-600 max-w-2xl mx-auto font-light leading-relaxed transform-gpu will-change-transform will-change-opacity"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 relative items-stretch">
          ...
          <motion.div 
            ...
            className="group relative h-full transform-gpu will-change-transform will-change-opacity"
          >
