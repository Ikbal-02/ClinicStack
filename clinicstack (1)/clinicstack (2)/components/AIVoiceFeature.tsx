      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10 w-full">
        ...
        <div className="text-center mb-12 md:mb-20">
          <motion.h2 
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-medium text-slate-900 tracking-tight mb-4 md:mb-6 font-sans transform-gpu will-change-transform"
          >
          ...
          <motion.p 
            ...
            className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto font-light leading-relaxed transform-gpu will-change-transform"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 mb-12 md:mb-16">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "0px 0px 400px 0px" }}
            className="lg:col-span-2 lg:row-span-2 relative bg-white/80 backdrop-blur-2xl border-2 border-blue-100 rounded-[2.5rem] overflow-hidden group min-h-[500px] md:min-h-auto shadow-[0_0_50px_-12px_rgba(37,99,235,0.25)] ring-1 ring-blue-500/20 transform-gpu will-change-transform"
          >
          ...
          <motion.div 
            ...
            className="relative bg-white border border-blue-100 rounded-[2rem] p-8 flex flex-col justify-between group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 shadow-xl w-full transform-gpu will-change-transform"
          >
          ...
          <motion.div 
            ...
            className="relative bg-white border border-blue-100 rounded-[2rem] p-8 flex flex-col justify-between group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 overflow-hidden shadow-xl w-full transform-gpu will-change-transform"
          >
          ...
          <motion.div 
            ...
            className="md:col-span-3 lg:col-span-3 bg-white border border-blue-100 rounded-[2rem] p-8 flex flex-col md:flex-row items-center justify-between gap-8 group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 shadow-xl w-full transform-gpu will-change-transform"
          >
